...
export const CATEGORIES_CONFIG: CategoryInfo[] = [
  ...
  {
    id: 'engineering',
    name: 'Engineering & Computer Science Calculators',
    shortName: 'Engineering',
    description: "Time & space complexity, Big-O visualizers, K-Map solvers, Boolean logic, Ohm's law, resistor color codes, and RC circuits.",
    iconName: 'Cpu',
